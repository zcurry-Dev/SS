...
CREATE TABLE const.WorldRegion(
...
CREATE TABLE const.WorldCity(
	...
	,WorldRegionID INT NOT NULL
		...
		REFERENCES const.WorldRegion(WorldRegionID)
	,MajorCity BIT NOT NULL
		CONSTRAINT DF_WorldCity_MajorCity
		DEFAULT 0
)

INSERT INTO const.WorldCity
VALUES
('Toronto', 1, 1, 1)
,('Burlington', 1, 1, 0)
,('Paris', 3, 2, 1)
