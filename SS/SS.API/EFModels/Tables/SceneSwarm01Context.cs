...
namespace SS.API.EFModels.Tables
{
    public partial class SceneSwarm01Context : DbContext
    {
        ...
        public virtual DbSet<SsDays> SsDays { get; set; }
        public virtual DbSet<Ssevents> Ssevents { get; set; }
        public virtual DbSet<SseventTypes> SseventTypes { get; set; }
        public virtual DbSet<Ssusers> Ssusers { get; set; }
        public virtual DbSet<SsusersEmployeeXref> SsusersEmployeeXref { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AdminRoles>(entity =>
            {
                ...
                entity.ToTable("AdminRoles", "refSSAdmin");
            ...
            {
                entity.ToTable("AdminRolesXRef", "ssAdmin");
            ...
            modelBuilder.Entity<Admins>(entity =>
            {
                ...
                entity.Property(e => e.SsuserId).HasColumnName("SSUserID");

                entity.HasOne(d => d.Ssuser)
                    .WithMany(p => p.Admins)
                    .HasForeignKey(d => d.SsuserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Admins_SSUserID");
            });
            ...
            modelBuilder.Entity<Artists>(entity =>
            {
                ...
                entity.HasOne(d => d.ArtistStatus)
                    ...
                    .HasConstraintName("FK_Artists_ArtistStatusID");
            });
            ...
            modelBuilder.Entity<SsDays>(entity =>
            {
                entity.HasKey(e => e.SsDayId);

                entity.ToTable("ssDays", "const");

                entity.Property(e => e.SsDayId).HasColumnName("ssDayID");

                entity.Property(e => e.SsDay)
                    .HasColumnName("ssDay")
                    .HasMaxLength(255);
            });

            modelBuilder.Entity<Ssevents>(entity =>
            {
                entity.HasKey(e => e.SsEventId);

                entity.ToTable("SSEvents");

                entity.Property(e => e.SsEventId).HasColumnName("ssEventID");
                ...
                entity.HasOne(d => d.EventType)
                    .WithMany(p => p.Ssevents)
                    .HasForeignKey(d => d.EventTypeId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_SSEvent_EventTypeID");

                entity.HasOne(d => d.EventVenue)
                    .WithMany(p => p.Ssevents)
                    .HasForeignKey(d => d.EventVenueId)
                    .HasConstraintName("FK_SSEvents_EventVenueID");
            });

            modelBuilder.Entity<SseventTypes>(entity =>
            {
                entity.HasKey(e => e.SsEventTypeId);

                entity.ToTable("SSEventTypes", "ref");

                entity.Property(e => e.SsEventTypeId).HasColumnName("ssEventTypeID");
                ...
                entity.HasOne(d => d.CreatedByNavigation)
                    .WithMany(p => p.SseventTypes)
                    .HasForeignKey(d => d.CreatedBy)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_SSEventTypes_CreatedBy");
            });

            modelBuilder.Entity<Ssusers>(entity =>
            {
                entity.HasKey(e => e.SsuserId);

                entity.ToTable("SSUsers", "ssUser");
                ...
                entity.HasOne(d => d.UserStatus)
                    .WithMany(p => p.Ssusers)
                    .HasForeignKey(d => d.UserStatusId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_SSUsers_UserStatusID");
            });

            modelBuilder.Entity<SsusersEmployeeXref>(entity =>
            {
                entity.ToTable("SSUsersEmployeeXRef", "hr");

                entity.Property(e => e.SsusersEmployeeXrefId).HasColumnName("SSUsersEmployeeXRefID");
                ...
                entity.HasOne(d => d.Ssuser)
                    .WithMany(p => p.SsusersEmployeeXref)
                    .HasForeignKey(d => d.SsuserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_SSUsersEmployeeXRef_SSUserID");
            });
            ...
            modelBuilder.Entity<UserRoles>(entity =>
            {
                ...
                entity.ToTable("UserRoles", "refSSUser");
            ...
            modelBuilder.Entity<UserRolesXref>(entity =>
            {
                ...
                entity.ToTable("UserRolesXRef", "ssUser");
                ...
                entity.HasOne(d => d.Ssuser)
                    ...
                    .HasForeignKey(d => d.SsuserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_UserRoleXRef_SSUserID");
            ...
            modelBuilder.Entity<UserStatuses>(entity =>
            {
                ...
                entity.ToTable("UserStatuses", "refSSUser");
            ...
            modelBuilder.Entity<VenueHoursOpen>(entity =>
            {
                ...
                entity.HasOne(d => d.SsDay)
                    .WithMany(p => p.VenueHoursOpen)
                    .HasForeignKey(d => d.SsDayId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_VenueHoursOpen_ssDayID");
