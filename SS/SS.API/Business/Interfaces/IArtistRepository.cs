...
namespace SS.API.Business.Interfaces
{
    public interface IArtistRepository
    {
        ...
        Task<PagedList<ArtistDto>> GetArtists(ArtistParams artistParams);
        IEnumerable<ArtistForListDto> MapArtistsToDto(PagedList<ArtistDto> artists);
        Task<ArtistPhotoDto> GetArtistPhotoByArtistId(int artistId);
